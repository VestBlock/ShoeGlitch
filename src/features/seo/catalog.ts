...
const SERVICE_TEMPLATES: Record<SeoServiceSlug, SeoServiceTemplate> = {
  'sneaker-cleaning': {
    ...
    summaryLine: 'clear pricing tiers, local availability, and a faster path into booking',
    ctaPrimaryHref: '/book',
  ...
  'shoe-restoration': {
    ...
    summaryLine: 'restoration-first recommendations, clear service options, and a direct booking path',
    ctaPrimaryHref: '/book',
  ...
  'pickup-dropoff': {
    ...
    summaryLine: 'simple local handoff options and a cleaner path into booking',
