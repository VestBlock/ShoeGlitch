...
const SERVICE_TEMPLATES: Record<SeoServiceSlug, SeoServiceTemplate> = {
  'sneaker-cleaning': {
    ...
    summaryLine: 'tracked intake, city coverage, steam-assisted cleaning above the entry tier, and a clear booking path',
    ctaPrimaryHref: '/book',
  ...
  'shoe-restoration': {
    ...
    summaryLine: 'restoration-first recommendations, steam-assisted deep cleaning, and booking-ready next steps',
    ctaPrimaryHref: '/book',
