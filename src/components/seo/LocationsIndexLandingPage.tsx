...
export default function LocationsIndexLandingPage({ model }: { model: SeoLocationsIndexModel }) {
  const schemas = buildLocationsIndexSchemas(model);
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-bone">
        ...
        <div className="container-x relative py-12 md:py-16">
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1.08fr)_380px] xl:items-start">
            <div className="rounded-[2rem] border border-ink/10 bg-white/82 p-6 shadow-[0_20px_70px_rgba(10,15,31,0.06)] backdrop-blur-xl md:p-8">
              ...
              <h1 className="h-display text-[clamp(2.8rem,6vw,5rem)] leading-[0.92] tracking-tight">{model.h1}</h1>
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-2">
                <div className="rounded-[1.35rem] border border-ink/10 bg-bone-soft p-5">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.28em] text-glitch/85">Direct answer</div>
                ...
                <div className="rounded-[1.35rem] border border-ink/10 bg-white p-5">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.28em] text-glitch/85">Why this hub matters</div>
            ...
            <aside className="space-y-4 xl:sticky xl:top-24">
              <Card className="p-6">
                <div className="font-mono text-xs uppercase tracking-[0.28em] text-glitch/85">Live cities</div>
              ...
              <Card className="p-6">
                <div className="font-mono text-xs uppercase tracking-[0.28em] text-glitch/85">Best next moves</div>
