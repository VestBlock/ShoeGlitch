...
export default function WorthRestoringLandingPage({ model }: { model: ReleasePageModel }) {
  ...
  return (
    <>
      ...
      {schemas.map((schema, index) => (
        <script
          key={`worth-restoring-schema-${index}`}
      ...
      <section className="relative overflow-hidden bg-bone">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(23,110,255,0.14),transparent_42%),radial-gradient(circle_at_bottom_right,rgba(15,173,96,0.1),transparent_40%)] pointer-events-none" />
          ...
          <div className="grid gap-8 xl:grid-cols-[minmax(0,1.05fr)_minmax(340px,0.95fr)] xl:items-start">
            <article className="rounded-[2rem] border border-ink/10 bg-white/86 p-6 shadow-[0_24px_80px_rgba(10,15,31,0.07)] backdrop-blur-xl md:p-8">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <Badge tone="glitch">Preservation-first</Badge>
              ...
              <div className="mt-7 grid gap-4 md:grid-cols-[minmax(0,1.1fr)_300px]">
                <div className="rounded-[1.5rem] border border-ink/10 bg-[linear-gradient(135deg,rgba(255,255,255,0.92),rgba(236,244,255,0.82))] p-5">
                  <div className="text-[11px] font-semibold uppercase tracking-[0.28em] text-glitch/85">Quick restoration read</div>
                ...
                <div className="rounded-[1.5rem] border border-ink/10 bg-bone-soft p-5">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    {[
                      ...
                      ['Preservation', model.item.scores.preservationValue],
                      ['Sole risk', model.item.scores.soleRisk],
                      ['Material', model.item.scores.materialSensitivity],
                    ].map(([label, value]) => (
                      <div key={label} className="rounded-[1rem] border border-ink/10 bg-white px-4 py-3">
                        <div className="text-[11px] font-semibold uppercase tracking-[0.2em] text-ink/48">{label}</div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link href="/book?intent=restoration" className="btn-glitch" data-growth-cta="Book restoration">
                  Book restoration
                </Link>
            ...
            <aside className="space-y-5 xl:sticky xl:top-24">
              <div className="rounded-[2rem] border border-ink/10 bg-[linear-gradient(180deg,rgba(8,33,77,0.96),rgba(8,38,92,0.76))] p-4 shadow-[0_28px_90px_rgba(10,15,31,0.16)]">
          ...
          <article className="space-y-6">
            <Card className="p-6 md:p-8">
              <div className="prose-sg max-w-none">
                <section>
                  <h2>Why this pair is worth restoring</h2>
